...
typedef struct {
	...
	USART_TypeDef*    pInstance;  //Stores the USART_TypeDef for the UART peripheral (defined in stm32f407xx.h)

	IRQn_Type         eIRQ;       //Stores the IRQ Handler enum for the UART peripheral (defined in stm32f407xx.h)
...
public:
	...
	//Returns USART_TypeDef, as defined in stm32f407xx.h
